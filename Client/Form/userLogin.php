...
<?php
    ...
    <div class="container row mt-5 col-md-4 border border-success rounded w-25 m-auto shadow-lg p-3 bg-body-tertiary font-monospace ">
        <h2 class="m-auto text-center text-warning fw-bold my-3 ">User Sign-in</h2>
        <form action="login.php" method="POST">
            <label for="">User Name:</label>
            <input class="form-control my-2" type="text" name="name" placeholder="Enter Your username or E-mail" required />
            <label for="">User Password:</label>
            <input class="form-control my-2 mb-4" type="password" name="password" placeholder="Enter Your Password" required />

            <div class="text-center">
                <button name="submit" style="background: linear-gradient(90deg, rgba(2, 0, 36, 1) 0%, rgba(9, 9, 121, 1) 35%, rgba(0, 212, 255, 1) 100%);" class="fs-5 border rounded fw-bold text-white w-100" type="submit">Sign-in</button>
            </div>
        </form>
        <p class="my-2 p-2 ">
            Don't have an account? <a class="text-decoration-none " href="userRegistration.php">Create here</a>
        </p>
    </div>
